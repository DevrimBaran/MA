...
fn bench_yang_crummey_mpmc(c: &mut Criterion) {
    ...
    for &(num_prods, num_cons) in THREAD_COUNTS_TO_TEST {
        ...
        group.bench_function(
            format!("{}Prod_{}Cons_{}ItemsPer", num_prods, num_cons, items_per_thread),
            |b: &mut Bencher| {
...
criterion_group! {
    ...
    targets = bench_yang_crummey_mpmc,
}

criterion_main!(mpmc_benches);